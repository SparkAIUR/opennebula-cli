...
OFFICIAL_COMMAND_DESCRIPTIONS: dict[str, dict[str, str]] = {'acl': {'create': 'Adds a new ACL rule',
         'delete': 'Deletes an existing ACL rule',
         'list': 'Lists the ACL rule set.'},
 'backupjob': {'backup': 'Start the Backup Job execution.',
 ...
 'cfg': {'diff': 'Detect changes in configuration files',
 ...
 'cluster': {'adddatastore': 'Adds a Datastore to the given Cluster',
 ...
 'datastore': {'chgrp': 'Changes the Datastore group',
               ...
               'update': 'Update the template contents.'},
 'db': {'--expr': 'examples: UNAME=oneadmin, TEMPLATE/NIC/NIC_ID>0 If you want to change a value '
 ...
 'flow': {'action': 'Perform an action on all the Virtual Machines of a given role.',
          ...
          'update': 'Update the template contents.'},
 'flow-template': {'chgrp': 'Changes the service template group',
                   ...
                   'update': 'Update the template contents.'},
 'group': {'addadmin': 'Adds a User to the Group administrators set',
           ...
           'update': 'Update the template contents.'},
 'hook': {'create': 'Creates a new Hook from the given description - using a Hook description '
 ...
 'host': {'create': 'Creates a new Host',
          ...
          'update': 'Update the template contents.'},
 'image': {'chgrp': 'Changes the Image group',
           ...
           'update': 'Update the template contents.'},
 'log': {'get': 'Gets log from an specific OpenNebula service',
         'get-service': 'Gets Service log',
         'get-vm': 'Gets VM log'},
 'market': {'chgrp': 'Changes the Marketplace group',
            ...
            'update': 'Update the template contents.'},
 'marketapp': {'chgrp': 'Changes the marketplace app group',
               ...
               'lock': 'Locks a marketplace app to prevent certain actions defined by different '
                       'levels.',
 ...
 'secgroup': {'chgrp': "Changes the Security Group's group",
              ...
              'update': 'Update the template contents.'},
 'showback': {'calculate': 'Calculates the showback records',
              'list': 'Returns the showback records'},
 'swap': {'convert': "Convert a vCenter Virtual Machine VOPTS='--vcenter 12.34.56.78 --vuser "
          ...
          'list': 'Show a list with vCenter objects, default to VM - listing all VMs: oneswap list '
                  ...
                  'Cluster2'},
 'template': {'chgrp': 'Changes the Template group',
              ...
              'update': 'Update the template contents.'},
 'user': {'addgroup': 'Adds the User to a secondary group',
          ...
          'update': 'Update the template contents.'},
 'vdc': {'addcluster': 'Adds a Cluster (from a specific Zone) to the given VDC',
         ...
         'update': 'Update the template contents.'},
 'vm': {'backup': 'Creates a VM backup on the given datastore States: RUNNING, POWEROFF',
 ...
 'vmgroup': {'chgrp': "Changes the VM Group's group",
             ...
             'update': 'Update the template contents.'},
 'vnet': {'addar': 'Adds an address range to the Virtual Network',
 ...
 'vntemplate': {'chgrp': 'Changes the VN Template group',
                ...
                'lock': 'Locks a VN Template to prevent certain actions defined by different '
                        'levels.',
 ...
 'vrouter': {'chgrp': 'Changes the Virtual Router group',
             ...
             'lock': 'Locks a Virtual Router to prevent certain actions defined by different '
                     'levels.',
